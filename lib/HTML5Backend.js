...
var HTML5Backend = (function () {
  ...
  HTML5Backend.prototype.addTopCaptureEventListeners = function addTopCaptureEventListeners(target) {
  ...
  HTML5Backend.prototype.removeTopCaptureEventListeners = function removeTopCaptureEventListeners(target) {
  ...
  HTML5Backend.prototype.connectDragSource = function connectDragSource(sourceId, node, options) {
    ...
    var iframe = _DOM.isInIframe(node) ? _DOM.getWindow(node) : null;
    iframe && this.addTopCaptureEventListeners(iframe);

    return function () {
      iframe && _this2.removeTopCaptureEventListeners(iframe);
  ...
  HTML5Backend.prototype.connectDropTarget = function connectDropTarget(targetId, node) {
    ...
    return function () {
      iframe && _this3.removeTopCaptureEventListeners(iframe);
  ...
  HTML5Backend.prototype.handleTopDragStart = function handleTopDragStart(e) {
    ...
    this.actions.beginDrag(dragStartSourceIds, {
      ...
      getEventOffset: function getEventOffset() {
        return _OffsetUtils.getEventOffset(e);
      }
    });
