...
var HTML5Backend = (function () {
  ...
  HTML5Backend.prototype.connectDragSource = function connectDragSource(sourceId, node, options) {
    ...
    var iframe = _OffsetUtils.isNodeInIframe(node) ? node.ownerDocument.defaultView : null;
    if (iframe) {
    ...
    return function () {
      if (iframe) {
        ...
        if (iframe.dndInIframeRef <= 0) {
          iframe.removeEventListener('dragstart', _this2.handleTopDragStartCapture, true);
          iframe.removeEventListener('dragend', _this2.handleTopDragEndCapture, true);
          iframe.removeEventListener('dragenter', _this2.handleTopDragEnterCapture, true);
          iframe.removeEventListener('dragleave', _this2.handleTopDragLeaveCapture, true);
          iframe.removeEventListener('dragover', _this2.handleTopDragOverCapture, true);
          iframe.removeEventListener('drop', _this2.handleTopDropCapture, true);
        }
      }
  ...
  HTML5Backend.prototype.connectDropTarget = function connectDropTarget(targetId, node) {
    ...
    return function () {
      if (iframe) {
        iframe.dndInIframeRef--;
        if (iframe.dndInIframeRef <= 0) {
          iframe.removeEventListener('dragstart', _this3.handleTopDragStartCapture, true);
          iframe.removeEventListener('dragend', _this3.handleTopDragEndCapture, true);
          iframe.removeEventListener('dragenter', _this3.handleTopDragEnterCapture, true);
          iframe.removeEventListener('dragleave', _this3.handleTopDragLeaveCapture, true);
          iframe.removeEventListener('dragover', _this3.handleTopDragOverCapture, true);
          iframe.removeEventListener('drop', _this3.handleTopDropCapture, true);
        }
      }
  ...
  HTML5Backend.prototype.handleDragStart = function handleDragStart(e, sourceId) {
    ...
    if (_OffsetUtils.isNodeInIframe(e.target)) {
